...
# Lymphnode scRNAseq sample analysis ______________________________________________________________________________________
# 
...
screen -r -d LN_example # run first time: screen -S LN_example
...
environment = initialize.project (
	datasets = c('LN1'), # List of dataset code names
	origins = c('Lymphnode'), # List of dataset tissue origin/condition full name
