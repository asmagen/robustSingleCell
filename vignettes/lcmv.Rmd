...
`read.data` function reads the data in 10X genomics format and performs quality filtering as described in *Magen et al 2018* [^3]. We randomly downsampled the datasets to 1000 cells to shorten the simplify this example.
...
<figure>
<img src="figs/Clustering.modularity.pdf">
...
<figure>
<img src="figs/PC1_heatmap.pdf" width="500">
...
<figure>
<img src="figs/diff.genes.pdf" width="500"> 
...
<figure>
<img src="figs/cor_FC.pdf" width = "500"> 
