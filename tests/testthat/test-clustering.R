...
# summarize(LCMV1)
# library(ggplot2)
# plot.contour.overlay.tSNE (LCMV1,genes = c('Cxcr5','Cxcr6','Cd4','Cd8a'),perplexity = 10,max_iter = 10000,width = 10, height = 10)
# plot.pair.scatter (LCMV1,gene1 = 'Cxcr5',gene2 = 'Tcf7',cluster_group1 = c('Unknown_2','Tcmp'),cluster_group2 = c('CD8','Cycle_CD8'),group1_label = 'Tfh_Tcmp',group2_label = 'CD8',width = 10, height = 10)
