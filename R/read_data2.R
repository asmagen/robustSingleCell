...
read.data <- function(sce, genome = "mm10", min.genes.per.cell = 500, max.genes.per.cell.quantile = 0.98,
                      max.UMIs.per.cell.quantile = 0.98, min.cells.per.gene = 1, max.mitochondrial.frac = 0.1,
                      max.ribosomal.frac = NA, cell.filters = NA, rerun = F, subsample = NULL, seed = 0) {

  cache <- file.path(tempdir(), "data.rds")
